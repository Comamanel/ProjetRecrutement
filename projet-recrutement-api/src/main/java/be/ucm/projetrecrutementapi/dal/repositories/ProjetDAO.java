...
public interface ProjetDAO extends JpaRepository<Projet, Long> {
    ...
    @Query(value="SELECT p"
            ...
            + " AND ( :#{#filtres.dateDebutEgal} is null OR p.dateDebut = :#{#filtres.dateDebutEgal} )"
            + " AND ( :#{#filtres.dateDebutAvant} is null OR p.dateDebut < :#{#filtres.dateDebutAvant} )"
            + " AND ( :#{#filtres.dateDebutApres} is null OR p.dateDebut > :#{#filtres.dateDebutApres} )"
            ...
            + " AND ( :#{#filtres.dateFinEgal} is null OR p.dateFin = :#{#filtres.dateFinEgal} )"
            + " AND ( :#{#filtres.dateFinAvant} is null OR p.dateFin < :#{#filtres.dateFinAvant} )"
            + " AND ( :#{#filtres.dateFinApres} is null OR p.dateFin > :#{#filtres.dateFinApres} )"
